...
const Semanas = () => {
  return (
    <div className="text-center mb-10">
      ...
      <div className="flex flex-row justify-center items-start gap-8 max-w-6xl mx-auto w-full mt-10">
        {/* Cambios en la madre */}
        <div className="flex-1 basis-1/3 bg-white border border-[#E3D5B7] rounded-xl p-6 shadow-md h-[280px]">
        ...
        {/* Imagen en el centro */}
        <div className="flex-1 basis-1/3 h-[400px] flex justify-center items-center">
          <img
            src="/public/didi1.png"
            alt="Ilustración semana"
            className="rounded-2xl shadow-md object-cover h-full w-auto"
          />
        </div>
      ...
      <div className="flex gap-4 justify-center mt-6">
        <Boton texto="---Home---" tipo="secundario" to="/" />
        <Boton
          texto="---Calendario---"
          tipo="secundario"
