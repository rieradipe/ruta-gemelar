...
function Home() {
  ...
  return (
    ...
    <p className="text-sm text-[#3A3F58] mb-4">
      ...
      Una experiencia profunda, desafiante y a menudo solitaria,que nuestra creadora vivió en primera persona.<br />
      Esta app es un espacio íntimo para reflexionar, registrar emociones y sentirse menos sola en este viaje.
    </p>
    ...
    <div className="flex gap-4 justify-center mt-6">
      <Boton texto="---Iniciar sesión---" tipo="secundario" to="/login" />
