...
const Registro = () => {
  return (
    <div className="flex flex-col items-center px-6 py-6 bg-[#FDF7F1]">
      ...
      <div
        className="flex flex-row md:flex-row gap-10 bg-white border-[3px] border-[#B6654F]  rounded-2xl shadow-lg p-6 md:p-10 max-w-2xl  mt-10"
      ...
      >
        ...
        <div className="flex justify-center gap-10 mt-6">
          ...
          <Boton texto="---Guardar---     " tipo="secundario" />
        </div>
      </div>
  );
};
